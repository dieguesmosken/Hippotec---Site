    ...
    <div class="w3-row-padding w3-padding-64 w3-container">
        <div class="w3-content">
            <div class="w3-twothird">
                <h1>HIPPOTEC</h1>
                <h5 class="w3-padding-32">A HIPPOTEC É UMA EMPRESA VOLTADA PARA A INOVAÇÃO DIGITAL DENTRO DA
                    MEDICINA,
    ...
    <div class="w3-row-padding w3-light-grey w3-padding-64 w3-container">
        <div class="w3-content">
            ...
            <div class="w3-twothird">
                ...
                <h5 class="w3-padding-32">Percebendo as dificuldades enfrentadas entre os médicos e pacientes em diagnosticar doenças, desenvolvemos um aplicativo de pré-diagnostico, onde o usuário insere os seus sintomas e uma pesquisa mostra para o usuário quais possíveis doenças</h5>
