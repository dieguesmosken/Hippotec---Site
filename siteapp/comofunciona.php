...
<body>
    ...
    <div class="w3-top">
        <div class="w3-bar w3-blue w3-card w3-left-align w3-large">
            ...
            <a href="cadastro/index_cdst.html"
                ...
                <div class="w3-cell-row">
                    ...
                    <div class="w3-container w3-cell w3-pale-green">
                        <div class="card-body">
                            ...
                            <h4 class="card-title">Os Avisos: </h4>
                            <h6> PRETO : Comum, doenças pouco agressivas mas comuns na sociedade. </h6>
                            <h6 style="color:red"> VERMELHO : Consultar, Doenças comuns porém possivelmente agressivas.
                            </h6>
                            <h6 style="color: orange"> AMARELO :Fatal, Doenças altamente agressivas e mortais em casos
                                graves. </h6>
                        </div>
                    ...
                    <div class="w3-container w3-cell w3-pale-green">
                        <div class="card-body">
                            <img src="IMG/doenca02.png" width="300px" height="500px" class="card-img" alt="doe2">
                            <h4 class="card-title">TITULO TEST: </h4>
                            <h6>Descrição teste</h6>
