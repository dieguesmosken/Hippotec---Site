...
<body>
    ...
    <div class="w3-top">
        <div class="w3-bar w3-blue w3-card w3-left-align w3-large">
            ...
            <a href="../index.php" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white">SITE
                EMPRESA</a>
            ...
            <a href="../../hpt_V2.0/View/" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white">
                BAIXAR APLICATIVO</a>
        ...
        <div class="w3-content">
            <div class="w3-twothird">
                ...
                <h3 class="w3-padding-32"> Hippotec é um aplicativo de pré-diagnostico,
                    onde o usuário vai colocar os seus sintomas que vai gerar uma pesquisa e irá mostrar pro usuário
                    quais possíveis doenças e sua gravidade. Esse nosso projeto irá ajudar a dar diagnósticos mais
                    rápidos,
        ...
        <div class="w3-content">
            ...
            <div class="w3-twothird">
                ...
                <h3 class="w3-padding-32">Percebendo as dificuldades enfrentadas entre os médicos e pacientes
                    em diagnosticar doenças, desenvolvemos um aplicativo de pré-diagnostico, onde o usuário insere os
                    seus sintomas e
